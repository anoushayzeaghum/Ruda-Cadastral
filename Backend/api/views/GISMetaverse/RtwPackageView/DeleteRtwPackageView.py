...
class DeleteRtwPackageView(viewsets.ViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return ApiResponse(
                ...
                message="RtwPackage deleted successfully.",
            ...
            return ApiResponse(
                ...
                message="Cannot delete this RtwPackage because it is linked to other records.",
