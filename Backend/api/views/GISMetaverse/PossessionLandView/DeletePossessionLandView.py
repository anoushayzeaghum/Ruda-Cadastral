...
class DeletePossessionLandView(viewsets.ViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return ApiResponse(
                ...
                message="PossessionLand deleted successfully.",
            ...
            return ApiResponse(
                ...
                message="Cannot delete this PossessionLand because it is linked to other records.",
