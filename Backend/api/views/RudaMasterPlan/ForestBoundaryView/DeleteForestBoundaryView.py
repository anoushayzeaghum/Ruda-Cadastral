...
class DeleteForestBoundaryView(viewsets.ViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            record = ForestBoundary.objects.get(gid=record_id)
        ...
        try:
            ...
            return ApiResponse(
                ...
                message="ForestBoundary deleted successfully.",
            ...
            return ApiResponse(
                ...
                message="Cannot delete this ForestBoundary because it is linked to other records.",
