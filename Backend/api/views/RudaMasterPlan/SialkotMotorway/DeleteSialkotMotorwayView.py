...
class DeleteSialkotMotorwayView(viewsets.ViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return ApiResponse(
                ...
                message="SialkotMotorway deleted successfully.",
            ...
            return ApiResponse(
                ...
                message="Cannot delete this SialkotMotorway because it is linked to other records.",
