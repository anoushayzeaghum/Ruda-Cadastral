...
class DeleteHardoSohalMuslimRoadView(viewsets.ViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return ApiResponse(
                ...
                message="HardoSohalMuslimRoad deleted successfully.",
            ...
            return ApiResponse(
                ...
                message="Cannot delete this HardoSohalMuslimRoad because it is linked to other records.",
