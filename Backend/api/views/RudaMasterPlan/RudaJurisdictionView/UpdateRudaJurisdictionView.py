...
class UpdateRudaJurisdictionView(viewsets.ViewSet):
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            serializer = RudaJurisdictionSerializer(record, data=data, partial=True)
            ...
            if serializer.is_valid():
                ...
                return ApiResponse(
                    ...
                    message="RudaJurisdiction updated successfully.",
