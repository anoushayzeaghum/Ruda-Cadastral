...
class UpdateExistingForestView(viewsets.ViewSet):
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            serializer = ExistingForestSerializer(record, data=data, partial=True)
            ...
            if serializer.is_valid():
                ...
                return ApiResponse(
                    ...
                    message="ExistingForest updated successfully.",
