...
class DeleteTransportationRoadsView(viewsets.ViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return ApiResponse(
                ...
                message="TransportationRoads deleted successfully.",
            ...
            return ApiResponse(
                ...
                message="Cannot delete this TransportationRoads because it is linked to other records.",
