...
class ListWWTPSitesView(viewsets.ViewSet):
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            if gid:
                record = WWTPSites.objects.filter(gid=gid).first()
                ...
                serializer = WWTPSitesSerializer(record)
            ...
            serializer = WWTPSitesSerializer(queryset, many=True)
    ...
    def geojson(self, request, pk=None):
        try:
            record = WWTPSites.objects.filter(gid=pk).first()
