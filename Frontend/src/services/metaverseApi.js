...
export const createKmzPrintLog = async (payload) => {
  const response = await axios.post(`${API_BASE}/kmz-print-logs/`, payload);
  return response.data?.data || response.data;
};

export const getKmzPrintLogs = async () => {
  const response = await axios.get(`${API_BASE}/kmz-print-logs/`);
