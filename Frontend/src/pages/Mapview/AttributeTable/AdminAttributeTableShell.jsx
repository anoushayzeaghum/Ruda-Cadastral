...
export default function AdminAttributeTableShell({
    ...
    return () => {
      ...
      if (window.__openAttributeTables) {
        ...
        if (window.__activeAttributeTable === title) {
          window.__activeAttributeTable =
            window.__openAttributeTables[0] || null;
        }
      }
      if (window.__attributeTableCloseCallbacks) {
  ...
  return (
    ...
    >
            ...
            return (
              ...
              >
                <Layers
                  size={10}
                  className={
                    isActive ? "animate-pulse text-[#9be37b]" : "text-white/30"
                  }
                />
      ...
      <div
        className={`transition-all duration-300 ease-in-out ${isMinimized ? "max-h-0 opacity-0 pointer-events-none" : "max-h-[480px] opacity-100"}`}
      >
