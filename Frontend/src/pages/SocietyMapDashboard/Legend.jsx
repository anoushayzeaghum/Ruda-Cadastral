...
export default function Legend({
  ...
  return (
    <aside className="pointer-events-auto absolute bottom-5 left-5 z-30 w-[310px] overflow-hidden rounded-xl border border-slate-200 bg-white/95 shadow-2xl backdrop-blur-md">
      <button
        type="button"
